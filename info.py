...
# Bot information
API_ID = environ.get('API_ID', '28996064')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', 'e09920a63e5f157b85a64ddba66596c6') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6005627579') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1003087205651').split()]
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002280652416") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://defensive-tedi-akklecture01-856bc967.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
